...
export function emitMakePrivateRoom(socket, { roomId }) {
  socket.emit('makePrivateRoom', { roomId });
}

export function emitEnterPrivateRoom(socket, { nickname, roomId }) {
  socket.emit('enterPrivateRoom', { nickname, roomId });
}
